function SoundEvent(name, time, type, options) {
  ...
  var offset = settings.update_freq / 1.8;
  this.window_start = moment(time);
  this.window_start.subtract(offset, "ms");

  this.window_end = moment(time);
  this.window_end.add(offset, "ms");
